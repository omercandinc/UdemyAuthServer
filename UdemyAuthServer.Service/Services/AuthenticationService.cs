...
namespace UdemyAuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        {
            var client = _clients.SingleOrDefault(x => x.Id == clientLoginDto.ClientId && x.Secret == clientLoginDto.ClientId);
            if (client == null)
            {
        ...
        public async Task<Response<TokenDto>> CreateTokkenByRefreshToken(string refreshToken)
        {
        ...
        public async Task<Response<NoDataDto>> RevokeRefresToken(string refreshToken)
        {
            var existRefreshToken = await _userRefreshTokenService.Where(x => x.Code == refreshToken).SingleOrDefaultAsync();
